...
public class DummyHandler implements UseCaseHandler {
    ...
    public DummyHandler() {
        ...
        _makler.add(new EstateAgent(3, "Benjamin Bl�mchen", "Im Zoo", "Elefant", "123"));
        ...
        _kunden.add(new Person(1, "D�rte", "Bauer", "Vom Acker 46"));
        ...
        _vertraege.add(new PurchaseContract(4, new Date(2010, 1, 2), "Dr�ben", 70, 458.1));
